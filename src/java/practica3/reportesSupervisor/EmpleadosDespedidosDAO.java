...
public class EmpleadosDespedidosDAO {
    ...
    public void imprimirReporteEmpleados(Date fechaInicial, Date fechaFinal, HttpServletRequest request, String area){
        ...
        try {
            jasperPrint2 = JasperFillManager.fillReport(getClass().getResourceAsStream("/practica3/reportesSupervisor/ReporteEmpleadosDespedidos.jasper"), null, new JRBeanCollectionDataSource(listarEmpleados(fechaInicial, fechaFinal, request, area)));
    ...
    public ArrayList<HistorialLaboral> listarEmpleados(Date fechaInicial, Date fechaFinal, HttpServletRequest request, String area){
    ...
    private ArrayList<HistorialLaboral> listarTipoEmpleado(Date fechaInicial, Date fechaFinal, String estado, ArrayList<HistorialLaboral> list) throws SQLException{
