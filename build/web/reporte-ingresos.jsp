<%-- 
    Document   : reporte-ingresos
    Created on : 19/11/2019, 12:49:28 AM
    Author     : luisGonzalez
--%>
    ...
    <body>
        ...
        <div class="container"><br><br>
            <form action="ControladorReportesAdmin" method="POST">
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="accion" value="reporte ingresos">Ver reporte</button>                                                                                         
            </form>
        </div>
