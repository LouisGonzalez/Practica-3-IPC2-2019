<%-- 
    Document   : tarifa-costo-cirugia
    Created on : 13/11/2019, 11:28:15 AM
    Author     : luisGonzalez
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<Tarifas> listar= dao.listarCostosCirugia();
        %>
        <div class="container"><br><br>
            <h1>Costos por cirugia</h1>
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="ControladorTarifas?id=<%=tarifa.getId()%>" method="POST">
                            ...
                            <td>
                                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="accion" value="Actualizar costos por operacion">Actualizar costos por operacion</button>                                                             
                            </td>
                        </form>
                    </tr>
                    <%
